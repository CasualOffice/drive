...
Live tracking is on the **[Doc-Hub Roadmap project board](https://github.com/orgs/CasualOffice/projects)**; discussion and requests go to **[Discussions](https://github.com/CasualOffice/dochub/discussions)**.
...
The order above is a default, not a contract. If your use-case needs Phase 4 compliance before Phase 3 search, say so in [Discussions](https://github.com/CasualOffice/dochub/discussions) — priorities move with real needs.
