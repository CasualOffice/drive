...
5. **Polished, minimalistic design.** macOS-app-grade polish. The [10 commandments](https://github.com/CasualOffice/drive/blob/main/docs/research/04-polish-principles.md) are enforced.
