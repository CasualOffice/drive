...
//! lives in `dochub-storage::secret_box`; this crate stays free of crypto.
...
/// `dochub_storage::byo::Provider` byte-for-byte — keep the two in sync.
...
pub struct WorkspaceStorage {
    ...
    /// `dochub_storage::open_secret` with AAD `<id>:<key_version>`.
