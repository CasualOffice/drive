...
use dochub_db::{AuditRepo, DbError, NewAuditEvent, NewSession, NewUser, SessionRepo, UserRepo};
...
const COOKIE_NAME_PROD: &str = "__Host-dh_sid";
const COOKIE_NAME_DEV: &str = "dh_sid";
